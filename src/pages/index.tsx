  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Car Sharing Application, your go-to platform for convenient, reliable, and eco-friendly vehicle sharing. Drive less, share more, and save the planet!"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Car Sharing Application, your go-to platform for convenient, reliable, and eco-friendly vehicle sharing. Drive less, share more, and save the planet!`}
            </Text>
            <Box
